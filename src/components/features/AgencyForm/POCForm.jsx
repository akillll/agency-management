...
export default function POCForm({ selectedPOCIndex }) {
  ...
  return (
    <div className="space-y-4 border-t border-gray-700 pt-4">
      {/* Name */}
      <div>
        <label className="text-sm text-gray-300">POC Name*</label>
        <div className="flex gap-2">
          <select
            value={poc.gender}
            onChange={(e) => handleChange("gender", e.target.value)}
            className="bg-gray-800 border border-gray-600 rounded-lg px-2"
          >
            <option>Mr.</option>
            <option>Ms.</option>
          </select>
      ...
      {/* Email */}
      <div>
        <label className="text-sm text-gray-300">POC Email</label>
        <Input
          type="email"
          value={poc.email}
      ...
      {/* Phone */}
      <div>
        <label className="text-sm text-gray-300">POC Number</label>
        <div className="flex gap-2">
          <select
